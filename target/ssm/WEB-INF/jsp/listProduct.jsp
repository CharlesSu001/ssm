...
<div style="width:500px;margin:0px auto;text-align:center">
    ...
    <div style="text-align:center">
        ...
        <a href="?id=${category.id}&start=${(page.start-page.count)<0?0:(page.start-page.count)}">上一页</a>
        <a href="?id=${category.id}&start=${(page.start+page.count)>page.last?page.last:(page.start+page.count)}">下一页</a>
